...
var EmojiRun = class {
  constructor(data) {
    ...
    this.text = ((_a4 = data.emoji) === null || _a4 === void 0 ? void 0 : _a4.emojiId) || ((_c = (_b = data.emoji) === null || _b === void 0 ? void 0 : _b.shortcuts) === null || _c === void 0 ? void 0 : _c[0]) || "";
    this.emoji = {
...
var HTTPClient = class {
  ...
  fetch(input, init) {
    return (0, import_tslib8.__awaiter)(this, void 0, void 0, function* () {
      ...
      request_url.searchParams.set("key", (0, import_tslib8.__classPrivateFieldGet)(this, _HTTPClient_session, "f").key);
      ...
      const response = yield (0, import_tslib8.__classPrivateFieldGet)(this, _HTTPClient_fetch, "f").call(this, request, {
        body: request_body,
...
var CommentThread = class extends YTNode {
  ...
  getReplies() {
    ...
    return (0, import_tslib11.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib11.__classPrivateFieldGet)(this, _CommentThread_actions, "f"))
      ...
      const response = yield continuation.endpoint.call((0, import_tslib11.__classPrivateFieldGet)(this, _CommentThread_actions, "f"), { parse: true });
      if (!response.on_response_received_endpoints_memo)
        throw new InnertubeError("Unexpected response.", response);
      this.replies = observe(response.on_response_received_endpoints_memo.getType(Comment_default).map((comment) => {
        comment.setActions((0, import_tslib11.__classPrivateFieldGet)(this, _CommentThread_actions, "f"));
        return comment;
      }));
      (0, import_tslib11.__classPrivateFieldSet)(this, _CommentThread_continuation, response === null || response === void 0 ? void 0 : response.on_response_received_endpoints_memo.getType(ContinuationItem_default).first(), "f");
      return this;
    });
  }
  getContinuation() {
    ...
    return (0, import_tslib11.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!(0, import_tslib11.__classPrivateFieldGet)(this, _CommentThread_continuation, "f"))
        throw new InnertubeError("Continuation not found.");
      if (!(0, import_tslib11.__classPrivateFieldGet)(this, _CommentThread_actions, "f"))
        throw new InnertubeError("Actions instance not set for this thread.");
      const load_more_button = (_a4 = (0, import_tslib11.__classPrivateFieldGet)(this, _CommentThread_continuation, "f").button) === null || _a4 === void 0 ? void 0 : _a4.as(Button_default);
      if (!load_more_button)
        throw new InnertubeError('"Load more" button not found.');
      const response = yield load_more_button.endpoint.call((0, import_tslib11.__classPrivateFieldGet)(this, _CommentThread_actions, "f"), { parse: true });
      if (!response.on_response_received_endpoints_memo)
        throw new InnertubeError("Unexpected response.", response);
      this.replies = observe(response.on_response_received_endpoints_memo.getType(Comment_default).map((comment) => {
        comment.setActions((0, import_tslib11.__classPrivateFieldGet)(this, _CommentThread_actions, "f"));
      ...
      (0, import_tslib11.__classPrivateFieldSet)(this, _CommentThread_continuation, response.on_response_received_endpoints_memo.getType(ContinuationItem_default).first(), "f");
      return this;
    });
  }
  get has_continuation() {
    ...
    return !!(0, import_tslib11.__classPrivateFieldGet)(this, _CommentThread_continuation, "f");
  }
  setActions(actions) {
    (0, import_tslib11.__classPrivateFieldSet)(this, _CommentThread_actions, actions, "f");
  }
};
...
var MusicResponsiveListItem = class extends YTNode {
  constructor(data) {
    ...
    (0, import_tslib12.__classPrivateFieldSet)(this, _MusicResponsiveListItem_playlist_item_data, {
    ...
    switch (page_type) {
      case "MUSIC_PAGE_TYPE_ALBUM":
        ...
        (0, import_tslib12.__classPrivateFieldGet)(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parseAlbum).call(this);
        break;
      case "MUSIC_PAGE_TYPE_PLAYLIST":
        this.item_type = "playlist";
        (0, import_tslib12.__classPrivateFieldGet)(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parsePlaylist).call(this);
        break;
      case "MUSIC_PAGE_TYPE_ARTIST":
      case "MUSIC_PAGE_TYPE_USER_CHANNEL":
        this.item_type = "artist";
        (0, import_tslib12.__classPrivateFieldGet)(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parseArtist).call(this);
        break;
      case "MUSIC_PAGE_TYPE_LIBRARY_ARTIST":
        this.item_type = "library_artist";
        (0, import_tslib12.__classPrivateFieldGet)(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parseLibraryArtist).call(this);
        break;
      case "MUSIC_PAGE_TYPE_NON_MUSIC_AUDIO_TRACK_PAGE":
        this.item_type = "non_music_track";
        (0, import_tslib12.__classPrivateFieldGet)(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parseNonMusicTrack).call(this);
        break;
      default:
        if (this.flex_columns[1]) {
          (0, import_tslib12.__classPrivateFieldGet)(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parseVideoOrSong).call(this);
        } else {
          (0, import_tslib12.__classPrivateFieldGet)(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parseOther).call(this);
        }
    }
...
_MusicResponsiveListItem_playlist_item_data = /* @__PURE__ */ new WeakMap(), _MusicResponsiveListItem_instances = /* @__PURE__ */ new WeakSet(), _MusicResponsiveListItem_parseOther = /* @__PURE__ */ __name(function _MusicResponsiveListItem_parseOther2() {
  ...
  var _a4, _b;
  const is_video = (_b = (_a4 = this.flex_columns.at(1)) === null || _a4 === void 0 ? void 0 : _a4.title.runs) === null || _b === void 0 ? void 0 : _b.some((run) => run.text.match(/(.*?) views/));
  if (is_video) {
    this.item_type = "video";
    (0, import_tslib12.__classPrivateFieldGet)(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parseVideo).call(this);
  } else {
    this.item_type = "song";
    (0, import_tslib12.__classPrivateFieldGet)(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parseSong).call(this);
  }
  ...
  this.id = (0, import_tslib12.__classPrivateFieldGet)(this, _MusicResponsiveListItem_playlist_item_data, "f").video_id || ((_b = (_a4 = this.endpoint) === null || _a4 === void 0 ? void 0 : _a4.payload) === null || _b === void 0 ? void 0 : _b.videoId);
  this.title = this.flex_columns.first().title.toString();
  ...
  this.id = (0, import_tslib12.__classPrivateFieldGet)(this, _MusicResponsiveListItem_playlist_item_data, "f").video_id;
  this.title = this.flex_columns.first().title.toString();
...
var TwoColumnWatchNextResults = class extends YTNode {
  constructor(data) {
    ...
    if (autoplayData) {
      this.autoplay = {
        sets: autoplayData.sets.map((set) => (0, import_tslib13.__classPrivateFieldGet)(this, _TwoColumnWatchNextResults_instances, "m", _TwoColumnWatchNextResults_parseAutoplaySet).call(this, set))
      };
      if (autoplayData.modifiedSets) {
        this.autoplay.modified_sets = autoplayData.modifiedSets.map((set) => (0, import_tslib13.__classPrivateFieldGet)(this, _TwoColumnWatchNextResults_instances, "m", _TwoColumnWatchNextResults_parseAutoplaySet).call(this, set));
      }
...
var KidsBlocklistPickerItem = class extends YTNode {
  ...
  blockChannel() {
    return (0, import_tslib14.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib14.__classPrivateFieldGet)(this, _KidsBlocklistPickerItem_actions, "f"))
        throw new InnertubeError("An active caller must be provide to perform this operation.");
      ...
      const response = yield button.endpoint.call((0, import_tslib14.__classPrivateFieldGet)(this, _KidsBlocklistPickerItem_actions, "f"), { parse: false });
      return response;
    });
  }
  setActions(actions) {
    (0, import_tslib14.__classPrivateFieldSet)(this, _KidsBlocklistPickerItem_actions, actions, "f");
  }
};
...
function createRuntimeClass(classname, key_info, logger) {
  ...
  const node = (_a4 = /* @__PURE__ */ __name(class extends YTNode {
    static set key_info(key_info2) {
      (0, import_tslib15.__classPrivateFieldSet)(this, _a4, new Map(key_info2), "f", _key_info);
    }
    static get key_info() {
      return [...(0, import_tslib15.__classPrivateFieldGet)(this, _a4, "f", _key_info).entries()];
    }
    constructor(data) {
      super();
  ...
  }, "_a"), (0, import_tslib15.__setFunctionName)(_a4, "node"), _a4.type = classname, _key_info = { value: /* @__PURE__ */ new Map() }, _a4);
...
var Format = class {
  constructor(data, this_response_nsig_cache) {
    ...
    if (this_response_nsig_cache) {
      (0, import_tslib16.__classPrivateFieldSet)(this, _Format_this_response_nsig_cache, this_response_nsig_cache, "f");
    }
    this.itag = data.itag;
  ...
  decipher(player) {
    ...
    return player.decipher(this.url, this.signature_cipher, this.cipher, (0, import_tslib16.__classPrivateFieldGet)(this, _Format_this_response_nsig_cache, "f"));
  }
};
...
var ERROR_HANDLER = /* @__PURE__ */ __name((_a4) => {
  var { classname } = _a4, context = (0, import_tslib17.__rest)(_a4, ["classname"]);
  switch (context.error_type) {
    case "parse":
      if (context.error instanceof Error) {
        Log_default.warn(TAG, new InnertubeError(`Something went wrong at ${classname}!
This is a bug, please report it at ${Platform.shim.info.bugs_url}`, {
      ...
      break;
    case "typecheck":
      Log_default.warn(TAG, new ParsingError(`Type mismatch, got ${classname} expected ${Array.isArray(context.expected) ? context.expected.join(" | ") : context.expected}.`, context.classdata));
      break;
    case "mutation_data_missing":
      Log_default.warn(TAG, new InnertubeError(`Mutation data required for processing MusicMultiSelectMenuItems, but none found.
This is a bug, please report it at ${Platform.shim.info.bugs_url}`));
      break;
    case "mutation_data_invalid":
      Log_default.warn(TAG, new InnertubeError(`Mutation data missing or invalid for ${context.failed} out of ${context.total} MusicMultiSelectMenuItems. The titles of the failed items are: ${context.titles.join(", ")}.
This is a bug, please report it at ${Platform.shim.info.bugs_url}`));
      break;
    case "class_not_found":
      Log_default.warn(TAG, new InnertubeError(`${classname} not found!
...
${generateTypescriptClass(classname, context.key_info)}`));
      break;
    case "class_changed":
      Log_default.warn(TAG, `${classname} changed!
The following keys where altered: ${context.changed_keys.map(([key]) => camelToSnake(key)).join(", ")}
The class has changed to:
${generateTypescriptClass(classname, context.key_info)}`);
      break;
    default:
      Log_default.warn(TAG, "Unreachable code reached at ParserErrorHandler");
      break;
  }
}, "ERROR_HANDLER");
...
function parseResponse(data) {
  ...
  if (data.playerConfig) {
    const player_config = {
      audio_config: {
        loudness_db: (_c = data.playerConfig.audioConfig) === null || _c === void 0 ? void 0 : _c.loudnessDb,
        perceptual_loudness_db: (_d = data.playerConfig.audioConfig) === null || _d === void 0 ? void 0 : _d.perceptualLoudnessDb,
        enable_per_format_loudness: (_e = data.playerConfig.audioConfig) === null || _e === void 0 ? void 0 : _e.enablePerFormatLoudness
      },
      stream_selection_config: {
        max_bitrate: ((_f = data.playerConfig.streamSelectionConfig) === null || _f === void 0 ? void 0 : _f.maxBitrate) || "0"
      },
      media_common_config: {
        dynamic_readahead_config: {
          max_read_ahead_media_time_ms: ((_h = (_g = data.playerConfig.mediaCommonConfig) === null || _g === void 0 ? void 0 : _g.dynamicReadaheadConfig) === null || _h === void 0 ? void 0 : _h.maxReadAheadMediaTimeMs) || 0,
          min_read_ahead_media_time_ms: ((_k = (_j = data.playerConfig.mediaCommonConfig) === null || _j === void 0 ? void 0 : _j.dynamicReadaheadConfig) === null || _k === void 0 ? void 0 : _k.minReadAheadMediaTimeMs) || 0,
          read_ahead_growth_rate_ms: ((_m = (_l = data.playerConfig.mediaCommonConfig) === null || _l === void 0 ? void 0 : _l.dynamicReadaheadConfig) === null || _m === void 0 ? void 0 : _m.readAheadGrowthRateMs) || 0
        }
      }
    };
...
var AccountInfo = class {
  constructor(response) {
    ...
    (0, import_tslib18.__classPrivateFieldSet)(this, _AccountInfo_page, parser_exports.parseResponse(response.data), "f");
    if (!(0, import_tslib18.__classPrivateFieldGet)(this, _AccountInfo_page, "f").contents)
      throw new InnertubeError("Page contents not found");
    const account_section_list = (0, import_tslib18.__classPrivateFieldGet)(this, _AccountInfo_page, "f").contents.array().as(AccountSectionList_default).first();
  ...
  get page() {
    return (0, import_tslib18.__classPrivateFieldGet)(this, _AccountInfo_page, "f");
  }
};
...
var Analytics = class {
  constructor(response) {
    ...
    (0, import_tslib19.__classPrivateFieldSet)(this, _Analytics_page, parser_exports.parseResponse(response.data), "f");
    this.sections = (_a4 = (0, import_tslib19.__classPrivateFieldGet)(this, _Analytics_page, "f").contents_memo) === null || _a4 === void 0 ? void 0 : _a4.getType(Element_default).map((el) => el.model).flatMap((el) => !el ? [] : el);
  }
  get page() {
    return (0, import_tslib19.__classPrivateFieldGet)(this, _Analytics_page, "f");
  }
};
...
var Feed = class {
  constructor(actions, response, already_parsed = false) {
    ...
    if ((0, import_tslib20.__classPrivateFieldGet)(this, _Feed_instances, "m", _Feed_isParsed).call(this, response) || already_parsed) {
      (0, import_tslib20.__classPrivateFieldSet)(this, _Feed_page, response, "f");
    } else {
      (0, import_tslib20.__classPrivateFieldSet)(this, _Feed_page, parser_exports.parseResponse(response.data), "f");
    }
    const memo = concatMemos(...[
      (0, import_tslib20.__classPrivateFieldGet)(this, _Feed_page, "f").contents_memo,
      (0, import_tslib20.__classPrivateFieldGet)(this, _Feed_page, "f").continuation_contents_memo,
      (0, import_tslib20.__classPrivateFieldGet)(this, _Feed_page, "f").on_response_received_commands_memo,
      (0, import_tslib20.__classPrivateFieldGet)(this, _Feed_page, "f").on_response_received_endpoints_memo,
      (0, import_tslib20.__classPrivateFieldGet)(this, _Feed_page, "f").on_response_received_actions_memo,
      (0, import_tslib20.__classPrivateFieldGet)(this, _Feed_page, "f").sidebar_memo,
      (0, import_tslib20.__classPrivateFieldGet)(this, _Feed_page, "f").header_memo
    ]);
    if (!memo)
      throw new InnertubeError("No memo found in feed");
    (0, import_tslib20.__classPrivateFieldSet)(this, _Feed_memo, memo, "f");
    (0, import_tslib20.__classPrivateFieldSet)(this, _Feed_actions, actions, "f");
  }
  ...
  get videos() {
    return Feed.getVideosFromMemo((0, import_tslib20.__classPrivateFieldGet)(this, _Feed_memo, "f"));
  }
  get posts() {
    return (0, import_tslib20.__classPrivateFieldGet)(this, _Feed_memo, "f").getType(BackstagePost_default, Post_default, SharedPost_default);
  }
  get channels() {
    return (0, import_tslib20.__classPrivateFieldGet)(this, _Feed_memo, "f").getType(Channel_default, GridChannel_default);
  }
  get playlists() {
    return Feed.getPlaylistsFromMemo((0, import_tslib20.__classPrivateFieldGet)(this, _Feed_memo, "f"));
  }
  get memo() {
    return (0, import_tslib20.__classPrivateFieldGet)(this, _Feed_memo, "f");
  }
  get page_contents() {
    var _a4;
    const tab_content = (_a4 = (0, import_tslib20.__classPrivateFieldGet)(this, _Feed_memo, "f").getType(Tab_default)) === null || _a4 === void 0 ? void 0 : _a4.first().content;
    const reload_continuation_items = (0, import_tslib20.__classPrivateFieldGet)(this, _Feed_memo, "f").getType(ReloadContinuationItemsCommand).first();
    const append_continuation_items = (0, import_tslib20.__classPrivateFieldGet)(this, _Feed_memo, "f").getType(AppendContinuationItemsAction_default).first();
    return tab_content || reload_continuation_items || append_continuation_items;
  }
  get shelves() {
    return (0, import_tslib20.__classPrivateFieldGet)(this, _Feed_memo, "f").getType(Shelf_default, RichShelf_default, ReelShelf_default);
  }
  getShelf(title) {
  ...
  get secondary_contents() {
    var _a4, _b;
    if (!((_a4 = (0, import_tslib20.__classPrivateFieldGet)(this, _Feed_page, "f").contents) === null || _a4 === void 0 ? void 0 : _a4.is_node))
      return void 0;
    const node = (_b = (0, import_tslib20.__classPrivateFieldGet)(this, _Feed_page, "f").contents) === null || _b === void 0 ? void 0 : _b.item();
    if (!node.is(TwoColumnBrowseResults_default, TwoColumnSearchResults_default))
      return void 0;
    return node.secondary_contents;
  }
  get actions() {
    return (0, import_tslib20.__classPrivateFieldGet)(this, _Feed_actions, "f");
  }
  get page() {
    return (0, import_tslib20.__classPrivateFieldGet)(this, _Feed_page, "f");
  }
  get has_continuation() {
    return (0, import_tslib20.__classPrivateFieldGet)(this, _Feed_instances, "m", _Feed_getBodyContinuations).call(this).length > 0;
  }
  getContinuationData() {
    return (0, import_tslib20.__awaiter)(this, void 0, void 0, function* () {
      if ((0, import_tslib20.__classPrivateFieldGet)(this, _Feed_continuation, "f")) {
        if ((0, import_tslib20.__classPrivateFieldGet)(this, _Feed_continuation, "f").length === 0)
          throw new InnertubeError("There are no continuations.");
        const response = yield (0, import_tslib20.__classPrivateFieldGet)(this, _Feed_continuation, "f")[0].endpoint.call((0, import_tslib20.__classPrivateFieldGet)(this, _Feed_actions, "f"), { parse: true });
        return response;
      }
      (0, import_tslib20.__classPrivateFieldSet)(this, _Feed_continuation, (0, import_tslib20.__classPrivateFieldGet)(this, _Feed_instances, "m", _Feed_getBodyContinuations).call(this), "f");
      if ((0, import_tslib20.__classPrivateFieldGet)(this, _Feed_continuation, "f"))
...
_Feed_page = /* @__PURE__ */ new WeakMap(), _Feed_continuation = /* @__PURE__ */ new WeakMap(), _Feed_actions = /* @__PURE__ */ new WeakMap(), _Feed_memo = /* @__PURE__ */ new WeakMap(), _Feed_instances = /* @__PURE__ */ new WeakSet(), _Feed_isParsed = /* @__PURE__ */ __name(function _Feed_isParsed2(response) {
  ...
  if ((0, import_tslib20.__classPrivateFieldGet)(this, _Feed_page, "f").header_memo) {
    const header_continuations = (0, import_tslib20.__classPrivateFieldGet)(this, _Feed_page, "f").header_memo.getType(ContinuationItem_default);
    return (0, import_tslib20.__classPrivateFieldGet)(this, _Feed_memo, "f").getType(ContinuationItem_default).filter((continuation) => !header_continuations.includes(continuation));
  }
  return (0, import_tslib20.__classPrivateFieldGet)(this, _Feed_memo, "f").getType(ContinuationItem_default);
...
var FilterableFeed = class extends Feed_default {
  ...
  get filter_chips() {
    var _a4, _b;
    if ((0, import_tslib21.__classPrivateFieldGet)(this, _FilterableFeed_chips, "f"))
      return (0, import_tslib21.__classPrivateFieldGet)(this, _FilterableFeed_chips, "f") || [];
    ...
    (0, import_tslib21.__classPrivateFieldSet)(this, _FilterableFeed_chips, this.memo.getType(ChipCloudChip_default), "f");
    return (0, import_tslib21.__classPrivateFieldGet)(this, _FilterableFeed_chips, "f") || [];
  }
  get filters() {
...
var MediaInfo = class {
  constructor(data, actions, cpn) {
    ...
    (0, import_tslib22.__classPrivateFieldSet)(this, _MediaInfo_actions, actions, "f");
    ...
    (0, import_tslib22.__classPrivateFieldSet)(this, _MediaInfo_page, [info, next], "f");
    (0, import_tslib22.__classPrivateFieldSet)(this, _MediaInfo_cpn, cpn, "f");
    ...
    (0, import_tslib22.__classPrivateFieldSet)(this, _MediaInfo_playback_tracking, info.playback_tracking, "f");
  }
  toDash(url_transformer, format_filter, options = { include_thumbnails: false }) {
    ...
    return (0, import_tslib22.__awaiter)(this, void 0, void 0, function* () {
      const player_response = (0, import_tslib22.__classPrivateFieldGet)(this, _MediaInfo_page, "f")[0];
      ...
      return FormatUtils_exports.toDash(this.streaming_data, (_a4 = this.page[0].video_details) === null || _a4 === void 0 ? void 0 : _a4.is_post_live_dvr, url_transformer, format_filter, (0, import_tslib22.__classPrivateFieldGet)(this, _MediaInfo_cpn, "f"), (0, import_tslib22.__classPrivateFieldGet)(this, _MediaInfo_actions, "f").session.player, (0, import_tslib22.__classPrivateFieldGet)(this, _MediaInfo_actions, "f"), storyboards);
    });
  }
  getStreamingInfo(url_transformer, format_filter) {
    var _a4;
    return getStreamingInfo(this.streaming_data, (_a4 = this.page[0].video_details) === null || _a4 === void 0 ? void 0 : _a4.is_post_live_dvr, url_transformer, format_filter, this.cpn, (0, import_tslib22.__classPrivateFieldGet)(this, _MediaInfo_actions, "f").session.player, (0, import_tslib22.__classPrivateFieldGet)(this, _MediaInfo_actions, "f"), (0, import_tslib22.__classPrivateFieldGet)(this, _MediaInfo_page, "f")[0].storyboards ? (0, import_tslib22.__classPrivateFieldGet)(this, _MediaInfo_page, "f")[0].storyboards : void 0);
  }
  ...
  download(options = {}) {
    return (0, import_tslib22.__awaiter)(this, void 0, void 0, function* () {
      ...
      return FormatUtils_exports.download(options, (0, import_tslib22.__classPrivateFieldGet)(this, _MediaInfo_actions, "f"), this.playability_status, this.streaming_data, (0, import_tslib22.__classPrivateFieldGet)(this, _MediaInfo_actions, "f").session.player, this.cpn);
    });
  }
  getTranscript() {
    var _a4;
  ...
  addToWatchHistory(client_name = Constants_exports.CLIENTS.WEB.NAME, client_version = Constants_exports.CLIENTS.WEB.VERSION, replacement = "https://www.") {
    return (0, import_tslib22.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib22.__classPrivateFieldGet)(this, _MediaInfo_playback_tracking, "f"))
        throw new InnertubeError("Playback tracking not available");
      const url_params = {
        cpn: (0, import_tslib22.__classPrivateFieldGet)(this, _MediaInfo_cpn, "f"),
        fmt: 251,
        rtn: 0,
        rt: 0
      };
      const url = (0, import_tslib22.__classPrivateFieldGet)(this, _MediaInfo_playback_tracking, "f").videostats_playback_url.replace("https://s.", replacement);
      const response = yield (0, import_tslib22.__classPrivateFieldGet)(this, _MediaInfo_actions, "f").stats(url, {
        client_name,
        client_version
      }, url_params);
      return response;
  ...
  get actions() {
    return (0, import_tslib22.__classPrivateFieldGet)(this, _MediaInfo_actions, "f");
  }
  get cpn() {
    return (0, import_tslib22.__classPrivateFieldGet)(this, _MediaInfo_cpn, "f");
  }
  get page() {
    return (0, import_tslib22.__classPrivateFieldGet)(this, _MediaInfo_page, "f");
  }
};
...
var TabbedFeed = class extends Feed_default {
  constructor(actions, data, already_parsed = false) {
    ...
    (0, import_tslib23.__classPrivateFieldSet)(this, _TabbedFeed_actions, actions, "f");
    (0, import_tslib23.__classPrivateFieldSet)(this, _TabbedFeed_tabs, (_a4 = this.page.contents_memo) === null || _a4 === void 0 ? void 0 : _a4.getType(Tab_default), "f");
  }
  get tabs() {
    var _a4, _b;
    return (_b = (_a4 = (0, import_tslib23.__classPrivateFieldGet)(this, _TabbedFeed_tabs, "f")) === null || _a4 === void 0 ? void 0 : _a4.map((tab) => tab.title.toString())) !== null && _b !== void 0 ? _b : [];
  }
  getTabByName(title) {
    var _a4;
    return (0, import_tslib23.__awaiter)(this, void 0, void 0, function* () {
      const tab = (_a4 = (0, import_tslib23.__classPrivateFieldGet)(this, _TabbedFeed_tabs, "f")) === null || _a4 === void 0 ? void 0 : _a4.find((tab2) => tab2.title.toLowerCase() === title.toLowerCase());
      if (!tab)
        throw new InnertubeError(`Tab "${title}" not found`);
      if (tab.selected)
        return this;
      const response = yield tab.endpoint.call((0, import_tslib23.__classPrivateFieldGet)(this, _TabbedFeed_actions, "f"));
      return new TabbedFeed((0, import_tslib23.__classPrivateFieldGet)(this, _TabbedFeed_actions, "f"), response, false);
    });
  }
  getTabByURL(url) {
    var _a4;
    return (0, import_tslib23.__awaiter)(this, void 0, void 0, function* () {
      const tab = (_a4 = (0, import_tslib23.__classPrivateFieldGet)(this, _TabbedFeed_tabs, "f")) === null || _a4 === void 0 ? void 0 : _a4.find((tab2) => {
        var _a5;
  ...
  hasTabWithURL(url) {
    var _a4, _b;
    return (_b = (_a4 = (0, import_tslib23.__classPrivateFieldGet)(this, _TabbedFeed_tabs, "f")) === null || _a4 === void 0 ? void 0 : _a4.some((tab) => {
      var _a5;
...
var Comments = class {
  constructor(actions, data, already_parsed = false) {
    ...
    (0, import_tslib25.__classPrivateFieldSet)(this, _Comments_page, already_parsed ? data : parser_exports.parseResponse(data), "f");
    (0, import_tslib25.__classPrivateFieldSet)(this, _Comments_actions, actions, "f");
    const contents = (0, import_tslib25.__classPrivateFieldGet)(this, _Comments_page, "f").on_response_received_endpoints;
    if (!contents)
    ...
    this.contents = observe(threads.map((thread) => {
      var _a5;
      (_a5 = thread.comment) === null || _a5 === void 0 ? void 0 : _a5.setActions((0, import_tslib25.__classPrivateFieldGet)(this, _Comments_actions, "f"));
      thread.setActions((0, import_tslib25.__classPrivateFieldGet)(this, _Comments_actions, "f"));
      return thread;
    }));
    (0, import_tslib25.__classPrivateFieldSet)(this, _Comments_continuation, (_c = body_node === null || body_node === void 0 ? void 0 : body_node.contents) === null || _c === void 0 ? void 0 : _c.firstOfType(ContinuationItem_default), "f");
  }
  applySort(sort) {
    var _a4, _b, _c, _d;
    return (0, import_tslib25.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (button.selected)
        return this;
      const response = yield button.endpoint.call((0, import_tslib25.__classPrivateFieldGet)(this, _Comments_actions, "f"), { parse: true });
      return new Comments((0, import_tslib25.__classPrivateFieldGet)(this, _Comments_actions, "f"), response, true);
    });
  }
  createComment(text) {
    var _a4;
    return (0, import_tslib25.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield button.endpoint.call((0, import_tslib25.__classPrivateFieldGet)(this, _Comments_actions, "f"), { commentText: text });
      return response;
    });
  }
  getContinuation() {
    return (0, import_tslib25.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib25.__classPrivateFieldGet)(this, _Comments_continuation, "f"))
        throw new InnertubeError("Continuation not found");
      const data = yield (0, import_tslib25.__classPrivateFieldGet)(this, _Comments_continuation, "f").endpoint.call((0, import_tslib25.__classPrivateFieldGet)(this, _Comments_actions, "f"), { parse: true });
      const page = Object.assign({}, (0, import_tslib25.__classPrivateFieldGet)(this, _Comments_page, "f"));
      ...
      return new Comments((0, import_tslib25.__classPrivateFieldGet)(this, _Comments_actions, "f"), page, true);
    });
  }
  get has_continuation() {
    return !!(0, import_tslib25.__classPrivateFieldGet)(this, _Comments_continuation, "f");
  }
  get page() {
    return (0, import_tslib25.__classPrivateFieldGet)(this, _Comments_page, "f");
  }
};
...
var Guide = class {
  constructor(data) {
    ...
    (0, import_tslib26.__classPrivateFieldSet)(this, _Guide_page, parser_exports.parseResponse(data), "f");
    this.contents = (0, import_tslib26.__classPrivateFieldGet)(this, _Guide_page, "f").items.array().as(GuideSection_default, GuideSubscriptionsSection_default);
  }
  get page() {
    return (0, import_tslib26.__classPrivateFieldGet)(this, _Guide_page, "f");
  }
};
__name(Guide, "Guide");
...
var ItemMenu = class {
  constructor(data, actions) {
    ...
    (0, import_tslib30.__classPrivateFieldSet)(this, _ItemMenu_page, data, "f");
    (0, import_tslib30.__classPrivateFieldSet)(this, _ItemMenu_actions, actions, "f");
    ...
    (0, import_tslib30.__classPrivateFieldSet)(this, _ItemMenu_items, menu.as(Menu_default).items, "f");
  }
  selectItem(item) {
    return (0, import_tslib30.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (item instanceof Button_default) {
        ...
        const button = (0, import_tslib30.__classPrivateFieldGet)(this, _ItemMenu_items, "f").find((button2) => {
      ...
      const response = yield endpoint.call((0, import_tslib30.__classPrivateFieldGet)(this, _ItemMenu_actions, "f"), { parse: true });
      return response;
    });
  }
  items() {
    return (0, import_tslib30.__classPrivateFieldGet)(this, _ItemMenu_items, "f");
  }
  page() {
    return (0, import_tslib30.__classPrivateFieldGet)(this, _ItemMenu_page, "f");
  }
};
...
var Playlist2 = class extends Feed_default {
  constructor(actions, data, already_parsed = false) {
    ...
    this.info = Object.assign(Object.assign({}, (_b = this.page.metadata) === null || _b === void 0 ? void 0 : _b.item().as(PlaylistMetadata_default)), {
      ...
      total_items: (0, import_tslib31.__classPrivateFieldGet)(this, _Playlist_instances, "m", _Playlist_getStat).call(this, 0, primary_info),
      views: (0, import_tslib31.__classPrivateFieldGet)(this, _Playlist_instances, "m", _Playlist_getStat).call(this, 1, primary_info),
      last_updated: (0, import_tslib31.__classPrivateFieldGet)(this, _Playlist_instances, "m", _Playlist_getStat).call(this, 2, primary_info),
  ...
  constructor(actions, data) {
    ...
    this.sections = shelves.map((shelf) => {
      ...
      return {
        ...
        getAll: () => (0, import_tslib32.__classPrivateFieldGet)(this, _Library_instances, "m", _Library_getAll).call(this, shelf)
      };
    });
  }
  get history() {
...
var SmoothedQueue = class {
  constructor() {
    ...
    (0, import_tslib33.__classPrivateFieldSet)(this, _SmoothedQueue_last_update_time, null, "f");
    (0, import_tslib33.__classPrivateFieldSet)(this, _SmoothedQueue_estimated_update_interval, null, "f");
    (0, import_tslib33.__classPrivateFieldSet)(this, _SmoothedQueue_callback, null, "f");
    (0, import_tslib33.__classPrivateFieldSet)(this, _SmoothedQueue_action_queue, [], "f");
    (0, import_tslib33.__classPrivateFieldSet)(this, _SmoothedQueue_next_update_id, null, "f");
    (0, import_tslib33.__classPrivateFieldSet)(this, _SmoothedQueue_poll_response_delay_queue, new DelayQueue(), "f");
  }
  enqueueActionGroup(group) {
    if ((0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_last_update_time, "f") !== null) {
      const delay = Date.now() - (0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_last_update_time, "f");
      (0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_poll_response_delay_queue, "f").back.push(delay);
      if (5 < (0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_poll_response_delay_queue, "f").front.length + (0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_poll_response_delay_queue, "f").back.length) {
        if (!(0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_poll_response_delay_queue, "f").front.length) {
          (0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_poll_response_delay_queue, "f").front = (0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_poll_response_delay_queue, "f").back;
          (0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_poll_response_delay_queue, "f").front.reverse();
          (0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_poll_response_delay_queue, "f").back = [];
        }
        (0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_poll_response_delay_queue, "f").front.pop();
      }
      (0, import_tslib33.__classPrivateFieldSet)(this, _SmoothedQueue_estimated_update_interval, Math.max(...(0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_poll_response_delay_queue, "f").getValues()), "f");
    }
    (0, import_tslib33.__classPrivateFieldSet)(this, _SmoothedQueue_last_update_time, Date.now(), "f");
    (0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_action_queue, "f").push(group);
    if ((0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_next_update_id, "f") === null) {
      (0, import_tslib33.__classPrivateFieldSet)(this, _SmoothedQueue_next_update_id, setTimeout(this.emitSmoothedActions.bind(this)), "f");
    }
  }
  emitSmoothedActions() {
    (0, import_tslib33.__classPrivateFieldSet)(this, _SmoothedQueue_next_update_id, null, "f");
    if ((0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_action_queue, "f").length) {
      let delay = 1e4;
      if ((0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_estimated_update_interval, "f") !== null && (0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_last_update_time, "f") !== null) {
        delay = (0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_estimated_update_interval, "f") - Date.now() + (0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_last_update_time, "f");
      }
      delay = (0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_action_queue, "f").length < delay / 80 ? 1 : Math.ceil((0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_action_queue, "f").length / (delay / 80));
      const actions = flattenQueue((0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_action_queue, "f").splice(0, delay));
      if ((0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_callback, "f")) {
        (0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_callback, "f").call(this, actions);
      }
      if ((0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_action_queue, "f") !== null) {
        delay == 1 ? (delay = (0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_estimated_update_interval, "f") / (0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_action_queue, "f").length, delay *= Math.random() + 0.5, delay = Math.min(1e3, delay), delay = Math.max(80, delay)) : delay = 80;
        (0, import_tslib33.__classPrivateFieldSet)(this, _SmoothedQueue_next_update_id, setTimeout(this.emitSmoothedActions.bind(this), delay), "f");
      }
    }
  }
  clear() {
    if ((0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_next_update_id, "f") !== null) {
      clearTimeout((0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_next_update_id, "f"));
      (0, import_tslib33.__classPrivateFieldSet)(this, _SmoothedQueue_next_update_id, null, "f");
    }
    (0, import_tslib33.__classPrivateFieldSet)(this, _SmoothedQueue_action_queue, [], "f");
  }
  set callback(cb) {
    (0, import_tslib33.__classPrivateFieldSet)(this, _SmoothedQueue_callback, cb, "f");
  }
  get callback() {
    return (0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_callback, "f");
  }
  get action_queue() {
    return (0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_action_queue, "f");
  }
  get estimated_update_interval() {
    return (0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_estimated_update_interval, "f");
  }
  get last_update_time() {
    return (0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_last_update_time, "f");
  }
  get next_update_id() {
    return (0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_next_update_id, "f");
  }
  get poll_response_delay_queue() {
    return (0, import_tslib33.__classPrivateFieldGet)(this, _SmoothedQueue_poll_response_delay_queue, "f");
  }
};
...
var LiveChat2 = class extends EventEmitterLike_default {
  constructor(video_info) {
    ...
    (0, import_tslib34.__classPrivateFieldSet)(this, _LiveChat_video_id, video_info.basic_info.id, "f");
    (0, import_tslib34.__classPrivateFieldSet)(this, _LiveChat_channel_id, video_info.basic_info.channel_id, "f");
    (0, import_tslib34.__classPrivateFieldSet)(this, _LiveChat_actions, video_info.actions, "f");
    (0, import_tslib34.__classPrivateFieldSet)(this, _LiveChat_continuation, (_a4 = video_info.livechat) === null || _a4 === void 0 ? void 0 : _a4.continuation, "f");
    ...
    this.smoothed_queue.callback = (actions) => (0, import_tslib34.__awaiter)(this, void 0, void 0, function* () {
      if (!actions.length) {
        yield (0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_wait).call(this, 2e3);
      } else if (actions.length < 10) {
        yield (0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_emitSmoothedActions).call(this, actions);
      } else if (this.is_replay) {
        (0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_emitSmoothedActions).call(this, actions);
        yield (0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_wait).call(this, 2e3);
      } else {
        (0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_emitSmoothedActions).call(this, actions);
      }
      if (this.running) {
        (0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_pollLivechat).call(this);
      }
    });
  }
  on(type, listener) {
  ...
  start() {
    if (!this.running) {
      this.running = true;
      (0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_pollLivechat).call(this);
      (0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_pollMetadata).call(this);
    }
  }
  stop() {
  ...
  sendMessage(text) {
    return (0, import_tslib34.__awaiter)(this, void 0, void 0, function* () {
      const response = yield (0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_actions, "f").execute("/live_chat/send_message", {
        params: encodeMessageParams((0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_channel_id, "f"), (0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_video_id, "f")),
  ...
  applyFilter(filter) {
    ...
    if (filter === "TOP_CHAT") {
      if ((_d = menu_items === null || menu_items === void 0 ? void 0 : menu_items.at(0)) === null || _d === void 0 ? void 0 : _d.selected)
        return;
      (0, import_tslib34.__classPrivateFieldSet)(this, _LiveChat_continuation, (_e = menu_items === null || menu_items === void 0 ? void 0 : menu_items.at(0)) === null || _e === void 0 ? void 0 : _e.continuation, "f");
    } else {
      if ((_f = menu_items === null || menu_items === void 0 ? void 0 : menu_items.at(1)) === null || _f === void 0 ? void 0 : _f.selected)
        return;
      (0, import_tslib34.__classPrivateFieldSet)(this, _LiveChat_continuation, (_g = menu_items === null || menu_items === void 0 ? void 0 : menu_items.at(1)) === null || _g === void 0 ? void 0 : _g.continuation, "f");
    }
  }
  getItemMenu(item) {
    return (0, import_tslib34.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield item.key("menu_endpoint").instanceof(NavigationEndpoint_default).call((0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_actions, "f"), { parse: true });
      if (!response)
        throw new InnertubeError("Could not retrieve item menu.", item);
      return new ItemMenu_default(response, (0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_actions, "f"));
    });
  }
  selectButton(button) {
    return (0, import_tslib34.__awaiter)(this, void 0, void 0, function* () {
      const response = yield button.endpoint.call((0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_actions, "f"), { parse: true });
      return response;
    });
  }
};
...
_LiveChat_actions = /* @__PURE__ */ new WeakMap(), _LiveChat_video_id = /* @__PURE__ */ new WeakMap(), _LiveChat_channel_id = /* @__PURE__ */ new WeakMap(), _LiveChat_continuation = /* @__PURE__ */ new WeakMap(), _LiveChat_mcontinuation = /* @__PURE__ */ new WeakMap(), _LiveChat_retry_count = /* @__PURE__ */ new WeakMap(), _LiveChat_instances = /* @__PURE__ */ new WeakSet(), _LiveChat_pollLivechat = /* @__PURE__ */ __name(function _LiveChat_pollLivechat2() {
  (() => (0, import_tslib34.__awaiter)(this, void 0, void 0, function* () {
    var _a4, _b;
    try {
      const response = yield (0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_actions, "f").execute(this.is_replay ? "live_chat/get_live_chat_replay" : "live_chat/get_live_chat", { continuation: (0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_continuation, "f"), parse: true });
      ...
      (0, import_tslib34.__classPrivateFieldSet)(this, _LiveChat_continuation, contents.continuation.token, "f");
      if (contents.header) {
        this.initial_info = contents;
        this.emit("start", contents);
        if (this.running)
          (0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_pollLivechat2).call(this);
      } else {
        this.smoothed_queue.enqueueActionGroup(contents.actions);
      }
      (0, import_tslib34.__classPrivateFieldSet)(this, _LiveChat_retry_count, 0, "f");
    } catch (err) {
      this.emit("error", err);
      if (((0, import_tslib34.__classPrivateFieldSet)(this, _LiveChat_retry_count, (_b = (0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_retry_count, "f"), _a4 = _b++, _b), "f"), _a4) < 10) {
        yield (0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_wait).call(this, 2e3);
        (0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_pollLivechat2).call(this);
      } else {
  ...
  return (0, import_tslib34.__awaiter)(this, void 0, void 0, function* () {
    ...
    for (const action of action_queue) {
      yield (0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_wait).call(this, emit_delay_ms);
  ...
  (() => (0, import_tslib34.__awaiter)(this, void 0, void 0, function* () {
    ...
    try {
      const payload = { videoId: (0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_video_id, "f") };
      if ((0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_mcontinuation, "f")) {
        payload.continuation = (0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_mcontinuation, "f");
      }
      const response = yield (0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_actions, "f").execute("/updated_metadata", payload);
      const data = parser_exports.parseResponse(response.data);
      (0, import_tslib34.__classPrivateFieldSet)(this, _LiveChat_mcontinuation, (_a4 = data.continuation) === null || _a4 === void 0 ? void 0 : _a4.token, "f");
      this.metadata = {
      ...
      yield (0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_wait).call(this, 5e3);
      if (this.running)
        (0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_pollMetadata2).call(this);
    } catch (err) {
      yield (0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_wait).call(this, 2e3);
      if (this.running)
        (0, import_tslib34.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_pollMetadata2).call(this);
...
var NotificationsMenu = class {
  constructor(actions, response) {
    ...
    (0, import_tslib35.__classPrivateFieldSet)(this, _NotificationsMenu_actions, actions, "f");
    (0, import_tslib35.__classPrivateFieldSet)(this, _NotificationsMenu_page, parser_exports.parseResponse(response.data), "f");
    this.header = (0, import_tslib35.__classPrivateFieldGet)(this, _NotificationsMenu_page, "f").actions_memo.getType(SimpleMenuHeader_default).first();
    this.contents = (0, import_tslib35.__classPrivateFieldGet)(this, _NotificationsMenu_page, "f").actions_memo.getType(Notification_default);
  }
  getContinuation() {
    return (0, import_tslib35.__awaiter)(this, void 0, void 0, function* () {
      const continuation = (0, import_tslib35.__classPrivateFieldGet)(this, _NotificationsMenu_page, "f").actions_memo.getType(ContinuationItem_default).first();
      if (!continuation)
        throw new InnertubeError("Continuation not found");
      const response = yield continuation.endpoint.call((0, import_tslib35.__classPrivateFieldGet)(this, _NotificationsMenu_actions, "f"), { parse: false });
      return new NotificationsMenu((0, import_tslib35.__classPrivateFieldGet)(this, _NotificationsMenu_actions, "f"), response);
    });
  }
  get page() {
    return (0, import_tslib35.__classPrivateFieldGet)(this, _NotificationsMenu_page, "f");
  }
};
...
var Settings = class {
  constructor(actions, response) {
    ...
    (0, import_tslib37.__classPrivateFieldSet)(this, _Settings_actions, actions, "f");
    (0, import_tslib37.__classPrivateFieldSet)(this, _Settings_page, parser_exports.parseResponse(response.data), "f");
    this.sidebar = (_a4 = (0, import_tslib37.__classPrivateFieldGet)(this, _Settings_page, "f").sidebar) === null || _a4 === void 0 ? void 0 : _a4.as(SettingsSidebar_default);
    if (!(0, import_tslib37.__classPrivateFieldGet)(this, _Settings_page, "f").contents)
      throw new InnertubeError("Page contents not found");
    const tab = (0, import_tslib37.__classPrivateFieldGet)(this, _Settings_page, "f").contents.item().as(TwoColumnBrowseResults_default).tabs.array().as(Tab_default).get({ selected: true });
    if (!tab)
  ...
  selectSidebarItem(target_item) {
    return (0, import_tslib37.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield item.endpoint.call((0, import_tslib37.__classPrivateFieldGet)(this, _Settings_actions, "f"), { parse: false });
      return new Settings((0, import_tslib37.__classPrivateFieldGet)(this, _Settings_actions, "f"), response);
    });
  }
  ...
  get page() {
    return (0, import_tslib37.__classPrivateFieldGet)(this, _Settings_page, "f");
  }
};
...
var TimeWatched = class {
  constructor(response) {
    ...
    (0, import_tslib38.__classPrivateFieldSet)(this, _TimeWatched_page, parser_exports.parseResponse(response.data), "f");
    if (!(0, import_tslib38.__classPrivateFieldGet)(this, _TimeWatched_page, "f").contents)
      throw new InnertubeError("Page contents not found");
    const tab = (0, import_tslib38.__classPrivateFieldGet)(this, _TimeWatched_page, "f").contents.item().as(SingleColumnBrowseResults_default).tabs.get({ selected: true });
    if (!tab)
  ...
  get page() {
    return (0, import_tslib38.__classPrivateFieldGet)(this, _TimeWatched_page, "f");
  }
};
...
var VideoInfo = class extends MediaInfo_default {
  constructor(data, actions, cpn) {
    ...
    if (results && secondary_results) {
      ...
      if (this.watch_next_feed && Array.isArray(this.watch_next_feed) && ((_6 = this.watch_next_feed.at(-1)) === null || _6 === void 0 ? void 0 : _6.is(ContinuationItem_default)))
        (0, import_tslib39.__classPrivateFieldSet)(this, _VideoInfo_watch_next_continuation, (_7 = this.watch_next_feed.pop()) === null || _7 === void 0 ? void 0 : _7.as(ContinuationItem_default), "f");
  ...
  getWatchNextContinuation() {
    var _a4, _b, _c, _d, _e;
    return (0, import_tslib39.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib39.__classPrivateFieldGet)(this, _VideoInfo_watch_next_continuation, "f"))
        throw new InnertubeError("Watch next feed continuation not found");
      const response = yield (_a4 = (0, import_tslib39.__classPrivateFieldGet)(this, _VideoInfo_watch_next_continuation, "f")) === null || _a4 === void 0 ? void 0 : _a4.endpoint.call(this.actions, { parse: true });
      ...
      if ((_d = (_c = this.watch_next_feed) === null || _c === void 0 ? void 0 : _c.at(-1)) === null || _d === void 0 ? void 0 : _d.is(ContinuationItem_default)) {
        (0, import_tslib39.__classPrivateFieldSet)(this, _VideoInfo_watch_next_continuation, (_e = this.watch_next_feed.pop()) === null || _e === void 0 ? void 0 : _e.as(ContinuationItem_default), "f");
      } else {
        (0, import_tslib39.__classPrivateFieldSet)(this, _VideoInfo_watch_next_continuation, void 0, "f");
      }
      return this;
    });
  }
  ...
  get wn_has_continuation() {
    return !!(0, import_tslib39.__classPrivateFieldGet)(this, _VideoInfo_watch_next_continuation, "f");
  }
...
var TranscriptInfo = class {
  constructor(actions, response) {
    ...
    (0, import_tslib40.__classPrivateFieldSet)(this, _TranscriptInfo_page, parser_exports.parseResponse(response.data), "f");
    (0, import_tslib40.__classPrivateFieldSet)(this, _TranscriptInfo_actions, actions, "f");
    this.transcript = (0, import_tslib40.__classPrivateFieldGet)(this, _TranscriptInfo_page, "f").actions_memo.getType(Transcript_default).first();
  }
  selectLanguage(language) {
    ...
    return (0, import_tslib40.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (target_menu_item.selected)
        return this;
      const response = yield (0, import_tslib40.__classPrivateFieldGet)(this, _TranscriptInfo_actions, "f").execute("/get_transcript", {
        params: target_menu_item.continuation
      });
      return new TranscriptInfo((0, import_tslib40.__classPrivateFieldGet)(this, _TranscriptInfo_actions, "f"), response);
    });
  }
  get languages() {
    var _a4, _b, _c, _d;
  ...
  get page() {
    return (0, import_tslib40.__classPrivateFieldGet)(this, _TranscriptInfo_page, "f");
  }
};
...
var Album = class {
  constructor(response) {
    ...
    (0, import_tslib41.__classPrivateFieldSet)(this, _Album_page, parser_exports.parseResponse(response.data), "f");
    this.header = (_a4 = (0, import_tslib41.__classPrivateFieldGet)(this, _Album_page, "f").header) === null || _a4 === void 0 ? void 0 : _a4.item().as(MusicDetailHeader_default);
...
var Artist = class {
  constructor(response, actions) {
    ...
    (0, import_tslib42.__classPrivateFieldSet)(this, _Artist_page, parser_exports.parseResponse(response.data), "f");
...
var Explore = class {
  constructor(response) {
    ...
    (0, import_tslib43.__classPrivateFieldSet)(this, _Explore_page, parser_exports.parseResponse(response.data), "f");
    const tab = (_a4 = (0, import_tslib43.__classPrivateFieldGet)(this, _Explore_page, "f").contents) === null || _a4 === void 0 ? void 0 : _a4.item().as(SingleColumnBrowseResults_default).tabs.get({ selected: true });
    if (!tab)
      throw new InnertubeError("Could not find target tab.");
...
var HomeFeed2 = class {
  constructor(response, actions) {
    ...
    (0, import_tslib44.__classPrivateFieldSet)(this, _HomeFeed_page, parser_exports.parseResponse(response.data), "f");
    const tab = (_a4 = (0, import_tslib44.__classPrivateFieldGet)(this, _HomeFeed_page, "f").contents) === null || _a4 === void 0 ? void 0 : _a4.item().as(SingleColumnBrowseResults_default).tabs.get({ selected: true });
    if (!tab)
...
var Library2 = class {
  constructor(response, actions) {
    ...
    (0, import_tslib45.__classPrivateFieldSet)(this, _Library_page, parser_exports.parseResponse(response.data), "f");
    (0, import_tslib45.__classPrivateFieldSet)(this, _Library_actions, actions, "f");
    const section_list = (_a4 = (0, import_tslib45.__classPrivateFieldGet)(this, _Library_page, "f").contents_memo) === null || _a4 === void 0 ? void 0 : _a4.getType(SectionList_default).first();
  ...
  applySort(sort_by) {
    ...
    return (0, import_tslib45.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (typeof sort_by === "string") {
        const button = (_a4 = (0, import_tslib45.__classPrivateFieldGet)(this, _Library_page, "f").contents_memo) === null || _a4 === void 0 ? void 0 : _a4.getType(MusicSortFilterButton_default).first();
  ...
  applyFilter(filter) {
    ...
    return (0, import_tslib45.__awaiter)(this, void 0, void 0, function* () {
      let target_chip;
      const chip_cloud = (_a4 = (0, import_tslib45.__classPrivateFieldGet)(this, _Library_page, "f").contents_memo) === null || _a4 === void 0 ? void 0 : _a4.getType(ChipCloud_default).first();
      if (typeof filter === "string") {
  ...
  get filters() {
    var _a4, _b;
    return ((_b = (_a4 = (0, import_tslib45.__classPrivateFieldGet)(this, _Library_page, "f").contents_memo) === null || _a4 === void 0 ? void 0 : _a4.getType(ChipCloud_default)) === null || _b === void 0 ? void 0 : _b.first().chips.map((chip) => chip.text)) || [];
  }
  get page() {
...
var LibraryContinuation = class {
  constructor(response, actions) {
    ...
    (0, import_tslib45.__classPrivateFieldSet)(this, _LibraryContinuation_page, parser_exports.parseResponse(response.data), "f");
...
var Playlist3 = class {
  constructor(response, actions) {
    ...
    (0, import_tslib46.__classPrivateFieldSet)(this, _Playlist_page, parser_exports.parseResponse(response.data), "f");
    ...
    if ((0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_page, "f").continuation_contents) {
      const data = (_a4 = (0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_page, "f").continuation_contents) === null || _a4 === void 0 ? void 0 : _a4.as(MusicPlaylistShelfContinuation);
  ...
  getRelated() {
    var _a4, _b, _c, _d, _e;
    return (0, import_tslib46.__awaiter)(this, void 0, void 0, function* () {
      let section_continuation = (_b = (_a4 = (0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_page, "f").contents_memo) === null || _a4 === void 0 ? void 0 : _a4.getType(SectionList_default)) === null || _b === void 0 ? void 0 : _b[0].continuation;
...
_Playlist_page = /* @__PURE__ */ new WeakMap(), _Playlist_actions = /* @__PURE__ */ new WeakMap(), _Playlist_continuation = /* @__PURE__ */ new WeakMap(), _Playlist_last_fetched_suggestions = /* @__PURE__ */ new WeakMap(), _Playlist_suggestions_continuation = /* @__PURE__ */ new WeakMap(), _Playlist_instances2 = /* @__PURE__ */ new WeakSet(), _Playlist_fetchSuggestions = /* @__PURE__ */ __name(function _Playlist_fetchSuggestions2() {
  var _a4, _b, _c, _d, _e;
  return (0, import_tslib46.__awaiter)(this, void 0, void 0, function* () {
    const continuation = (0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_suggestions_continuation, "f") || ((_b = (_a4 = (0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_page, "f").contents_memo) === null || _a4 === void 0 ? void 0 : _a4.get("SectionList")) === null || _b === void 0 ? void 0 : _b[0].as(SectionList_default).continuation);
    if (continuation) {
...
var Recap = class {
  constructor(response, actions) {
    ...
    (0, import_tslib47.__classPrivateFieldSet)(this, _Recap_page, parser_exports.parseResponse(response.data), "f");
    (0, import_tslib47.__classPrivateFieldSet)(this, _Recap_actions, actions, "f");
    const header = (_a4 = (0, import_tslib47.__classPrivateFieldGet)(this, _Recap_page, "f").header) === null || _a4 === void 0 ? void 0 : _a4.item();
...
var Search2 = class {
  constructor(response, actions, is_filtered) {
    ...
    (0, import_tslib48.__classPrivateFieldSet)(this, _Search_page, parser_exports.parseResponse(response.data), "f");
  ...
  get did_you_mean() {
    var _a4;
    return (_a4 = (0, import_tslib48.__classPrivateFieldGet)(this, _Search_page, "f").contents_memo) === null || _a4 === void 0 ? void 0 : _a4.getType(DidYouMean_default).first();
  }
  get showing_results_for() {
    var _a4;
    return (_a4 = (0, import_tslib48.__classPrivateFieldGet)(this, _Search_page, "f").contents_memo) === null || _a4 === void 0 ? void 0 : _a4.getType(ShowingResultsFor_default).first();
  }
  get message() {
    var _a4;
    return (_a4 = (0, import_tslib48.__classPrivateFieldGet)(this, _Search_page, "f").contents_memo) === null || _a4 === void 0 ? void 0 : _a4.getType(Message_default).first();
  }
  get songs() {
    var _a4;
...
var SearchContinuation = class {
  constructor(actions, response) {
    ...
    (0, import_tslib48.__classPrivateFieldSet)(this, _SearchContinuation_page, parser_exports.parseResponse(response.data), "f");
    this.header = (_a4 = (0, import_tslib48.__classPrivateFieldGet)(this, _SearchContinuation_page, "f").header) === null || _a4 === void 0 ? void 0 : _a4.item().as(MusicHeader_default);
...
var VideoInfo3 = class {
  constructor(data, actions) {
    ...
    (0, import_tslib53.__classPrivateFieldSet)(this, _VideoInfo_actions, actions, "f");
    const info = parser_exports.parseResponse(data[0].data);
    ...
    (0, import_tslib53.__classPrivateFieldSet)(this, _VideoInfo_watch_next_continuation2, (_b = watch_next.continuation_endpoint) === null || _b === void 0 ? void 0 : _b.as(ContinuationCommand), "f");
  }
  getWatchNextContinuation() {
    var _a4, _b;
    return (0, import_tslib53.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib53.__classPrivateFieldGet)(this, _VideoInfo_watch_next_continuation2, "f"))
        throw new InnertubeError("Watch next feed continuation not found");
      const response = yield (0, import_tslib53.__classPrivateFieldGet)(this, _VideoInfo_actions, "f").execute(reel_exports.WatchSequenceEndpoint.PATH, reel_exports.WatchSequenceEndpoint.build({
        sequenceParams: (0, import_tslib53.__classPrivateFieldGet)(this, _VideoInfo_watch_next_continuation2, "f").token
      }));
      if (!response.success) {
      ...
      (0, import_tslib53.__classPrivateFieldSet)(this, _VideoInfo_watch_next_continuation2, (_b = parsed.continuation_endpoint) === null || _b === void 0 ? void 0 : _b.as(ContinuationCommand), "f");
      return this;
    });
  }
};
...
var Author = class {
  constructor(item, badges, thumbs, id) {
    ...
    this.badges = Array.isArray(badges) ? parser_exports.parseArray(badges) : observe([]);
...
var Platform = class {
  static load(platform) {
    (0, import_tslib54.__classPrivateFieldSet)(Platform, _a2, platform, "f", _Platform_shim);
  }
  static get shim() {
    if (!(0, import_tslib54.__classPrivateFieldGet)(Platform, _a2, "f", _Platform_shim)) {
      throw new Error("Platform is not loaded");
    }
    return (0, import_tslib54.__classPrivateFieldGet)(Platform, _a2, "f", _Platform_shim);
  }
};
...
var OAuth = class {
  constructor(session) {
    ...
    (0, import_tslib56.__classPrivateFieldSet)(this, _OAuth_session, session, "f");
  }
  init(credentials) {
    return (0, import_tslib56.__awaiter)(this, void 0, void 0, function* () {
      (0, import_tslib56.__classPrivateFieldSet)(this, _OAuth_credentials, credentials, "f");
      if (this.validateCredentials()) {
        if (!this.has_access_token_expired)
          (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_session, "f").emit("auth", {
            credentials: (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_credentials, "f"),
            status: "SUCCESS"
          });
      } else if (!(yield (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_instances, "m", _OAuth_loadCachedCredentials).call(this))) {
        yield (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_instances, "m", _OAuth_getUserCode).call(this);
      }
    });
  }
  cacheCredentials() {
    ...
    return (0, import_tslib56.__awaiter)(this, void 0, void 0, function* () {
      ...
      const data = encoder.encode(JSON.stringify((0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_credentials, "f")));
      yield (_a4 = (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_session, "f").cache) === null || _a4 === void 0 ? void 0 : _a4.set("youtubei_oauth_credentials", data.buffer);
    });
  }
  removeCache() {
    var _a4;
    return (0, import_tslib56.__awaiter)(this, void 0, void 0, function* () {
      yield (_a4 = (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_session, "f").cache) === null || _a4 === void 0 ? void 0 : _a4.remove("youtubei_oauth_credentials");
    });
  }
  refreshIfRequired() {
    return (0, import_tslib56.__awaiter)(this, void 0, void 0, function* () {
      if (this.has_access_token_expired) {
        yield (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_instances, "m", _OAuth_refreshAccessToken).call(this);
      }
    });
  }
  revokeCredentials() {
    return (0, import_tslib56.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_credentials, "f"))
        return;
      yield this.removeCache();
      return (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_session, "f").http.fetch_function(new URL(`/o/oauth2/revoke?token=${encodeURIComponent((0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_credentials, "f").access_token)}`, Constants_exports.URLS.YT_BASE), {
        method: "post"
      });
    });
  }
  get credentials() {
    return (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_credentials, "f");
  }
  get has_access_token_expired() {
    const timestamp = (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_credentials, "f") ? new Date((0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_credentials, "f").expires).getTime() : -Infinity;
    return new Date().getTime() > timestamp;
  }
  validateCredentials() {
    return (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_credentials, "f") && Reflect.has((0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_credentials, "f"), "access_token") && Reflect.has((0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_credentials, "f"), "refresh_token") && Reflect.has((0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_credentials, "f"), "expires") || false;
  }
};
__name(OAuth, "OAuth");
_OAuth_identity = /* @__PURE__ */ new WeakMap(), _OAuth_session = /* @__PURE__ */ new WeakMap(), _OAuth_credentials = /* @__PURE__ */ new WeakMap(), _OAuth_polling_interval = /* @__PURE__ */ new WeakMap(), _OAuth_instances = /* @__PURE__ */ new WeakSet(), _OAuth_loadCachedCredentials = /* @__PURE__ */ __name(function _OAuth_loadCachedCredentials2() {
  var _a4;
  return (0, import_tslib56.__awaiter)(this, void 0, void 0, function* () {
    const data = yield (_a4 = (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_session, "f").cache) === null || _a4 === void 0 ? void 0 : _a4.get("youtubei_oauth_credentials");
    if (!data)
      return false;
    const decoder = new TextDecoder();
    const credentials = JSON.parse(decoder.decode(data));
    (0, import_tslib56.__classPrivateFieldSet)(this, _OAuth_credentials, {
  ...
  return (0, import_tslib56.__awaiter)(this, void 0, void 0, function* () {
    (0, import_tslib56.__classPrivateFieldSet)(this, _OAuth_identity, yield (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_instances, "m", _OAuth_getClientIdentity).call(this), "f");
    const data = {
      client_id: (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_identity, "f").client_id,
      scope: Constants_exports.OAUTH.SCOPE,
      device_id: Platform.shim.uuidv4(),
      device_model: Constants_exports.OAUTH.MODEL_NAME
    };
    const response = yield (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_session, "f").http.fetch_function(new URL("/o/oauth2/device/code", Constants_exports.URLS.YT_BASE), {
    ...
    (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_session, "f").emit("auth-pending", response_data);
    (0, import_tslib56.__classPrivateFieldSet)(this, _OAuth_polling_interval, response_data.interval, "f");
    (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_instances, "m", _OAuth_startPolling).call(this, response_data.device_code);
  });
}, "_OAuth_getUserCode"), _OAuth_startPolling = /* @__PURE__ */ __name(function _OAuth_startPolling2(device_code) {
  const poller = setInterval(() => (0, import_tslib56.__awaiter)(this, void 0, void 0, function* () {
    var _a4, _b;
    const data = Object.assign(Object.assign({}, (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_identity, "f")), { code: device_code, grant_type: Constants_exports.OAUTH.GRANT_TYPE });
    try {
      const response = yield (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_session, "f").http.fetch_function(new URL("/o/oauth2/token", Constants_exports.URLS.YT_BASE), {
        body: JSON.stringify(data),
        method: "POST",
        headers: {
          "Content-Type": "application/json"
      ...
      if (response_data.error) {
        switch (response_data.error) {
          case "access_denied":
            (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_session, "f").emit("auth-error", new OAuthError("Access was denied.", { status: "ACCESS_DENIED" }));
            break;
          case "expired_token":
            (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_session, "f").emit("auth-error", new OAuthError("The device code has expired, restarting auth flow.", { status: "DEVICE_CODE_EXPIRED" }));
            clearInterval(poller);
            (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_instances, "m", _OAuth_getUserCode).call(this);
            break;
          default:
            break;
        }
      ...
      (0, import_tslib56.__classPrivateFieldSet)(this, _OAuth_credentials, {
        ...
        client_id: (_a4 = (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_identity, "f")) === null || _a4 === void 0 ? void 0 : _a4.client_id,
        client_secret: (_b = (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_identity, "f")) === null || _b === void 0 ? void 0 : _b.client_secret,
      ...
      clearInterval(poller);
      return (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_session, "f").emit("auth-error", new OAuthError("Could not obtain user code.", { status: "FAILED", error: err }));
    }
  }), (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_polling_interval, "f") * 1e3);
}, "_OAuth_startPolling"), _OAuth_refreshAccessToken = /* @__PURE__ */ __name(function _OAuth_refreshAccessToken2() {
  return (0, import_tslib56.__awaiter)(this, void 0, void 0, function* () {
    if (!(0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_credentials, "f"))
      return;
    (0, import_tslib56.__classPrivateFieldSet)(this, _OAuth_identity, yield (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_instances, "m", _OAuth_getClientIdentity).call(this), "f");
    const data = Object.assign(Object.assign({}, (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_identity, "f")), { refresh_token: (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_credentials, "f").refresh_token, grant_type: "refresh_token" });
    const response = yield (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_session, "f").http.fetch_function(new URL("/o/oauth2/token", Constants_exports.URLS.YT_BASE), {
      body: JSON.stringify(data),
      method: "POST",
      headers: {
    ...
    (0, import_tslib56.__classPrivateFieldSet)(this, _OAuth_credentials, {
      access_token: response_data.access_token,
      refresh_token: response_data.refresh_token || (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_credentials, "f").refresh_token,
      client_id: (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_identity, "f").client_id,
      client_secret: (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_identity, "f").client_secret,
      expires: expiration_date
    }, "f");
    (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_session, "f").emit("update-credentials", {
      credentials: (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_credentials, "f"),
      status: "SUCCESS"
    });
  });
  ...
  var _a4, _b, _c;
  return (0, import_tslib56.__awaiter)(this, void 0, void 0, function* () {
    if (((_a4 = (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_credentials, "f")) === null || _a4 === void 0 ? void 0 : _a4.client_id) && ((_b = this.credentials) === null || _b === void 0 ? void 0 : _b.client_secret)) {
      Log_default.info(OAuth.TAG, "Using custom OAuth2 credentials.\n");
      return {
        client_id: (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_credentials, "f").client_id,
        client_secret: this.credentials.client_secret
      };
    }
    const response = yield (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_session, "f").http.fetch_function(new URL("/tv", Constants_exports.URLS.YT_BASE), { headers: Constants_exports.OAUTH.HEADERS });
    ...
    const script = yield (0, import_tslib56.__classPrivateFieldGet)(this, _OAuth_session, "f").http.fetch(url_body, { baseURL: Constants_exports.URLS.YT_BASE });
...
var Actions = class {
  constructor(session) {
    ...
    (0, import_tslib57.__classPrivateFieldSet)(this, _Actions_session, session, "f");
  }
  get session() {
    return (0, import_tslib57.__classPrivateFieldGet)(this, _Actions_session, "f");
  }
  stats(url, client, params) {
    return (0, import_tslib57.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield (0, import_tslib57.__classPrivateFieldGet)(this, _Actions_session, "f").http.fetch(s_url);
      return response;
    });
  }
    ...
    return (0, import_tslib57.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (args && !args.protobuf) {
        ...
        if (Reflect.has(data, "browseId")) {
          if ((0, import_tslib57.__classPrivateFieldGet)(this, _Actions_instances, "m", _Actions_needsLogin).call(this, data.browseId) && !(0, import_tslib57.__classPrivateFieldGet)(this, _Actions_session, "f").logged_in)
      ...
      const response = yield (0, import_tslib57.__classPrivateFieldGet)(this, _Actions_session, "f").http.fetch(target_endpoint, {
        method: "POST",
...
var Player = class {
  constructor(signature_timestamp, sig_sc, nsig_sc, player_id) {
    ...
    (0, import_tslib58.__classPrivateFieldSet)(this, _Player_nsig_sc, nsig_sc, "f");
    (0, import_tslib58.__classPrivateFieldSet)(this, _Player_sig_sc, sig_sc, "f");
    (0, import_tslib58.__classPrivateFieldSet)(this, _Player_sig_sc_timestamp, signature_timestamp, "f");
    (0, import_tslib58.__classPrivateFieldSet)(this, _Player_player_id, player_id, "f");
  }
  ...
  decipher(url, signature_cipher, cipher, this_response_nsig_cache) {
    ...
    if (signature_cipher || cipher) {
      const signature = Platform.shim.eval((0, import_tslib58.__classPrivateFieldGet)(this, _Player_sig_sc, "f"), {
        sig: args.get("s")
      });
    ...
    if (n) {
      ...
      if (this_response_nsig_cache && this_response_nsig_cache.has(n)) {
        ...
        nsig = Platform.shim.eval((0, import_tslib58.__classPrivateFieldGet)(this, _Player_nsig_sc, "f"), {
          nsig: n
        });
  ...
  cache(cache) {
    return (0, import_tslib58.__awaiter)(this, void 0, void 0, function* () {
      if (!cache)
        return;
      const encoder = new TextEncoder();
      const sig_buf = encoder.encode((0, import_tslib58.__classPrivateFieldGet)(this, _Player_sig_sc, "f"));
      const nsig_buf = encoder.encode((0, import_tslib58.__classPrivateFieldGet)(this, _Player_nsig_sc, "f"));
      const buffer = new ArrayBuffer(12 + sig_buf.byteLength + nsig_buf.byteLength);
      const view = new DataView(buffer);
      view.setUint32(0, Player.LIBRARY_VERSION, true);
      view.setUint32(4, (0, import_tslib58.__classPrivateFieldGet)(this, _Player_sig_sc_timestamp, "f"), true);
      ...
      yield cache.set((0, import_tslib58.__classPrivateFieldGet)(this, _Player_player_id, "f"), new Uint8Array(buffer));
    });
  }
  ...
  get url() {
    return new URL(`/s/player/${(0, import_tslib58.__classPrivateFieldGet)(this, _Player_player_id, "f")}/player_ias.vflset/en_US/base.js`, Constants_exports.URLS.YT_BASE).toString();
  }
  get sts() {
    return (0, import_tslib58.__classPrivateFieldGet)(this, _Player_sig_sc_timestamp, "f");
  }
  get nsig_sc() {
    return (0, import_tslib58.__classPrivateFieldGet)(this, _Player_nsig_sc, "f");
  }
  get sig_sc() {
    return (0, import_tslib58.__classPrivateFieldGet)(this, _Player_sig_sc, "f");
  }
  ...
  static getSessionData(lang = "", location = "", account_index = 0, visitor_data = "", enable_safety_mode = false, generate_session_locally = false, device_category = "desktop", client_name = ClientType.WEB, tz = Intl.DateTimeFormat().resolvedOptions().timeZone, fetch = Platform.shim.fetch, on_behalf_of_user) {
    return (0, import_tslib59.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (generate_session_locally) {
        session_data = (0, import_tslib59.__classPrivateFieldGet)(this, _a3, "m", _Session_generateSessionData).call(this, session_args);
      } else {
        try {
          session_data = yield (0, import_tslib59.__classPrivateFieldGet)(this, _a3, "m", _Session_retrieveSessionData).call(this, session_args, fetch);
        } catch (err) {
...
var { homepage, version, bugs } = { "homepage": "https://github.com/LuanRT/YouTube.js#readme", "version": "9.1.0", "bugs": { "url": "https://github.com/LuanRT/YouTube.js/issues" } };
